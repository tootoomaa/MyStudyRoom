...
class NewsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.loadDate<ArticleResponse>(url: URL(string: "https://newsapi.org/v2/top-headlines?country=us&apiKey=aab00f244cdd43558a60ae6c73002474")!) { decodeData in
            print(decodeData)
        }
    ...
    func loadDate<T: Codable>(url: URL, completion: @escaping (T) -> Void) {
